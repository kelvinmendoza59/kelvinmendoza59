...
#### ✅ [TaskFlow](https://github.com/kelvinmendoza59/task-manager-api)
Productivity platform for task management with real-time updates
- **Tech Stack**: Python, Flask, SQLAlchemy, SQLite

#### 📚 [LibraryHub](https://github.com/kelvinmendoza59/biblioteca-api-spring)
Complete library management system with book inventory tracking
- **Tech Stack**: Java, Spring Boot, JPA, H2 Database

#### 📈 [CS50x Finance](https://github.com/kelvinmendoza59/finance)
Stock trading simulator with real-time quotes - Harvard CS50x Final Project
- **Tech Stack**: Python, Flask, SQLite, IEX Cloud API

#### 🌐 [Personal Portfolio](https://github.com/kelvinmendoza59/portfolio-web)
Professional portfolio website with dark/light mode - **[Live Demo](https://portfolio-web-kelvin.vercel.app)**
